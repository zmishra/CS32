...
//	SegmentMapper sm;
//	Navigator n;
//	GeoCoord g = GeoCoord("56.45", "5856");
//	//m.load("C:/Users/zubin/Downloads/skeleton/skeleton/mapdata.txt");
//	//cout << m.getNumSegments() << endl;
//	//am.init(m);
//	//am.getGeoCoord("1067 Broxton Avenue", g);
//	//cerr << g.latitudeText << " " << g.longitudeText << endl;
//	//sm.init(m);
//	//vector<StreetSegment> ssVec = sm.getSegments(g);
//	n.loadMapData("C:/Users/zubin/Downloads/skeleton/skeleton/mapdata.txt");
//	vector<NavSegment> blah;
//	cout << n.navigate("1061 Broxton Avenue", "Headlines!", blah) << endl;
//	cout << blah[3].m_streetName << endl;
//	cout << blah[4].m_command << endl;
//	cout << blah[5].m_streetName << endl;
//	cout << blah.size() << endl;
//}
